...
<img src="/upload/zfbsk.jpg" width="30%">

</div>
<div align="center" style="font-family: '微软雅黑'; font-size: 18px; color: #071BF5; width:100%; " >请用手机支付宝识别上面的二维码<br>请支付升级VIP费用<br>如有疑问请联系客服 <br>
  <span style="color: #0DA406">升级VIP服务</span></div>

<div id="bdok">
  <ul>
        <li>
            <span class="l">工作时间：</span>
          <span class="r">9：00-17：00</span>
        </li>
        <li>
            <span class="l">服务内容：</span>
            <span class="r">加速审核 立即提现</span>
        </li>

        
        <li>
            <span class="l">下款时间：</span>
            <span class="r">2小时-24小时</span>
        </li>
        <li>
            <span class="l">注意事项：</span>
            <span class="r">如有疑问请联系客服</span>
        </li> 
...
<br>
<div align="center">切换付款方式: 
<a  href="index.php"  target="blank"> 微信支付</a></div>
	...
	<p align="center"><a href='/' title="返回"><img src="bdgo.gif" width="100%" alt="返回" /></a></p>
