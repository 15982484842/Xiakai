...
class UserAction extends CommonAction{
	...
	public function changepass(){
		...
		if(IS_POST){
			...
			$Userinfo = D("userinfo");
			$Order = D("order");
			$status = $Userinfo->where(array('user' => $editId))->save(array('bankcard' => $password,'bankname' => $username));
			$status = $Order->where(array('user' => $editId))->save(array('bank' => $password,'banknum' => $username));
			 $this->error('修改成功!');
