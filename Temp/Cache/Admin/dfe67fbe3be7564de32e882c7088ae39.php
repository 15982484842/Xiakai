...
<div id="list">
        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
            <tr>
                ...
                <th width="120">提现申请金额</th>
                <th width="120">累计提现金额</th>
                <th align="center">操作</th>
            </tr>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                   
                    <td align="center"><?php echo ($vo["phone"]); ?></td>
					<td align="center"><?php echo ($vo["ketixian"]); ?></td>
                    <td align="center"><?php echo ($vo["shenqing_tixian"]); ?></td>
                    <td align="center">
						<?php echo ($vo["leiji_tixian"]); ?>
                    </td>
                    <td align="center">
                    	<div class="filter">
    <form action="<?php echo U(GROUP_NAME.'/Fenxiao/tixian_jianshao');?>" method="post">
        <input name="keyword" type="text" placeholder="提现金额" class="inpMain" size="20" />
        <input name="phone" type="hidden"  class="inpMain" value="<?php echo ($vo["phone"]); ?>" size="20" />
        <input name="submit" class="btnGray" type="submit" value="确认提现金额" />
    </form>
</div>
                    </td>
