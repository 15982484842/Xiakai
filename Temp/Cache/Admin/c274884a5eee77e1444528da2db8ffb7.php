...
<div class="idTabs">
                    ...
                    <tr>
                       ...
                       <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="gulifei" value="<?php echo C('cfg_gulifei');?>" size="80" class="inpMain" />
  ...
  <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="yuqifei" value="<?php echo C('cfg_yuqifei');?>" size="80" class="inpMain" />
                        ...
                        <td>
                            ...
                            <input type="text" name="fenxiao" value="<?php echo C('cfg_fenxiao');?>" size="80" class="inpMain" />
            ...
            <div id="api">
                <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="sms_pass" value="<?php echo C('cfg_sms_pass');?>" size="80" class="inpMain" />
                        </td>
                    </tr>
