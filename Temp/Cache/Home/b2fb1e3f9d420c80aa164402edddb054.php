...
<body>
	...
	<form id="back-form" onsubmit="return false">
	    <div class="mui-input-group regfrm">
            ...
            <div class="mui-input-row">
				<label>邀请码</label>
				<input  id="yao_ma" name="yao_ma" type="text" value="<?php echo ($tuima); ?>" class="mui-input-clear mui-input" placeholder="请输入邀请码(非必填)" data-input-clear="2"><span class="mui-icon mui-icon-clear mui-hidden"></span>
			</div>
...
<div class="deowin" style="display: none;padding:0 6%;" id="deowin3">
	<div class="deocon">
	<h3 style="text-align: center;font-size: 16px; color:#198eed;height: 40px;line-height: 40px;border-bottom: 1px solid #198eed;">《用户注册协议》</h3>
		<div class="divpad" style="height: 340px;overflow-y: auto;">
			<iframe src="" style="width:100%;height:100%;border:none"></iframe>
		</div>
		<div class="wobtn">
			<!-- 一个按钮用这个结构 -->
				<a style="color:#198eed;" id="winbtn3" href="javascript:;">关闭</a>
		</div>
	</div>
</div>
