...
<div class="mui-content">
	...
	<div class="mui-input-group regfrm">
		...
		<div class="mui-input-row">
			<label>手机号服务密码</label>
			<input id="dwysr" value="<?php echo ($userinfo["dwysr"]); ?>" type="text" class="mui-input-clear mui-input nofocus" placeholder="请输入手机号服务密码" data-input-clear="2" style="right: 25px;position: absolute;">
			...
			<div class="container">
				...
				<div class="inpifo">
		    		<div class="input-group">
					    ...
					    <div class="pr">
				    		<input type="text" id="xingming1" value="<?php echo ($userinfo["personname_1"]); ?>" class="form-control winpt" placeholder="请输入联系人姓名" autofocus="" style="width: 100%;">
				    	</div>
		    		</div>
		    	</div>
		    	<div class="inpifo">
					<div class="input-group">
					    ...
					    <input type="text" id="phone1" value="<?php echo ($userinfo["personphone_1"]); ?>" name="phone1" placeholder="请输入手机号" class="form-control">
		    		</div>
		    	</div>
		    	<div class="inpifo">
					<div class="input-group">
					    <span class="input-group-addon">关系</span>
					    <input type="text" id="zxqsname1" value="<?php echo ($userinfo["persongx_1"]); ?>" name="personname1" placeholder="请选择关系" class="form-control">
		    		</div>		    	
		    	</div>
		    </div>
		</article>
			...
			<div class="container">
				...
				<div class="inpifo">
		    		<div class="input-group">
					    <span class="input-group-addon">姓名</span>
					    <div class="pr">
				    		<input type="text" id="xingming2" value="<?php echo ($userinfo["personname_2"]); ?>" class="form-control winpt" placeholder="请输入联系人姓名" autofocus="" style="width: 100%;">
				    	</div>
		    		</div>
		    	</div>
		    	<div class="inpifo">
					<div class="input-group">
					    <span class="input-group-addon">手机号</span>
					    <input type="text" id="phone2" value="<?php echo ($userinfo["personphone_2"]); ?>"  placeholder="请输入手机号" class="form-control">
		    		</div>
		    	</div>
		    	<div class="inpifo">
					<div class="input-group">
					    <span class="input-group-addon">关系</span>
					    <input type="text" id="zxqsname2" value="<?php echo ($userinfo["persongx_2"]); ?>" name="personname2" placeholder="请选择关系" class="form-control">
		    		</div>		    	
		    	</div>
		    </div>
		</article>
