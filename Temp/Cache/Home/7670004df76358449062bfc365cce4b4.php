        ...
        <div class="am-list-body">
            <div class="am-list-item">
                ...
                <div class="am-list-extra" style="position:relative;">
                    ...
                    <span class="mobile-select span_num"><?php echo ($phone); ?></span>
                </div>
            </div>
		...
		$.post(
			...
			function (data,state){
				if(state != "success"){
					...
					showmsg('校验码已发送至手机<span style="color:red;"><?php echo ($phone); ?></span>, 请在30分钟内输入');
					var index = 60;
